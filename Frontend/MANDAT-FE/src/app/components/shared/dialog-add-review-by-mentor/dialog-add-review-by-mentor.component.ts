...
@Component({
  selector: 'app-dialog-add-review-by-mentor',
  templateUrl: './dialog-add-review-by-mentor.component.html',
  styleUrls: ['./dialog-add-review-by-mentor.component.scss']
})
export class DialogAddReviewByMentorComponent implements OnInit{
  ngOnInit(): void { 
  ...
  constructor(
    private dialogRef: MatDialogRef<DialogAddReviewByMentorComponent>,
    ...
    if (this.role === this.roles.Student) {
